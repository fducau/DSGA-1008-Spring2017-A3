...
hr_dir = './data/img_align_celeba'
lr_dir = './data/resized/data/img_align_celeba'
out_base_dir = './data/img_align_celeba'

hr_test_dir = '{}180x120_test'.format(out_base_dir)
lr_test_dir = '{}55x45_test'.format(out_base_dir)

hr_val_dir = '{}180x120_val'.format(out_base_dir)
lr_val_dir = '{}55x45_val'.format(out_base_dir)

hr_train_dir = '{}180x120_train'.format(out_base_dir)
